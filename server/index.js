...
function buildSystemPrompt(tree, tieredMemory, responseLength, responseFormat, includeProjectContext, stalenessInfo, stance, auditLessons, pinnedContext, groundRules, queryText, analysisMode) {
  ...
  prompt += '\n- PLAIN TEXT OUTPUT ONLY: Never use Markdown syntax in user-visible responses. Do not emit asterisks, backticks, hash-prefixed headings, blockquote markers, Markdown links, or Markdown emphasis. Use ordinary sentences, plain headings, and numbered lists without formatting markers.';
